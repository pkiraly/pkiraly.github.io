...
In my practice I worked with two cases: looking for translations of an author, or translations from a particular language (specifying the _source language_). The search query looks like these:
