...
```
Note: Jakob Voß published [Avram specification](http://format.gbv.de/schema/avram/specification) after the publication of theoriginal version of this post. The content the JSON format was chanced, and the current version valid against Avram.
